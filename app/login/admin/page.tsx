        ...
        <div className="flex-1 w-full max-w-[480px]">
          <div className="bg-white/80 backdrop-blur-3xl border border-white/60 rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] p-8 md:p-14 relative overflow-hidden group">
            ...
            <div className="relative z-10 text-center mb-10">
              <h1 className="text-3xl font-black text-gray-900 mb-2">Administrator Login</h1>
              <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Security Gateway</p>
              {error && (
            ...
            <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-50/50 border border-transparent rounded-[20px] px-6 py-4 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-600/5 focus:bg-white focus:border-purple-600/10 transition-all duration-300"
              ...
              <div className="flex items-center justify-between px-2">
                ...
                <Link href="/forgot-password/admin" className="text-xs font-black text-purple-600 hover:text-purple-700 transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-purple-600 hover:bg-purple-700 text-white font-black py-5 rounded-[20px] shadow-[0_12px_24px_-8px_rgba(147,51,234,0.3)] hover:shadow-[0_20px_40px_-12px_rgba(147,51,234,0.4)] transition-all duration-300 transform active:scale-[0.98] text-lg uppercase tracking-widest flex items-center justify-center gap-3 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
                {loading && (
